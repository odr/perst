...
-- by name
instance TLens (a :: Symbol) (Tagged (Leaf (Just a)) va) where
  type LType a (Tagged (Leaf (Just a)) va) = va
  tlens f = fmap Tagged . f . untag

instance TLens (a :: Symbol) (Tagged (Leaf a) va) where
...
instance TLensB (num <=? BTreeCount l)
                  ...
                  (Tagged (Node l t r) v)
      => TLens (num::Nat) (Tagged (Node l t r) v) where
...
-- by names
instance TLens a b => TGetSet (Leaf a :: BTree t) b where
...
instance TLens a (Tagged l vl)
      => TLensB True a (Tagged (Node l t r) (vl,vr)) where
...
instance TLens a (Tagged r vr)
      => TLensB False a (Tagged (Node l t r) (vl,vr)) where
